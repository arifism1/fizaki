/**
 * A whisper of film grain over the whole page. At 3.5% it is invisible as a
 * texture but it stops the large flat colour fields — especially the dusk sky —
 * from banding and reading as cheap.
 */
